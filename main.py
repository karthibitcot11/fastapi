...
database_name = os.environ.get('database_name', 'apna')
db_username = urllib.parse.quote_plus(str(os.environ.get('db_username', 'apna')))
db_password = urllib.parse.quote_plus(str(os.environ.get('db_password', 'fqEDzm5Q2')))
